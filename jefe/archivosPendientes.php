...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if (strtolower($extension) != 'pdf') {
            ...
            $insertArchivos = "INSERT INTO archivos (id_permiso,id_aprueba,descripcion_solicita, ruta_aprueba) VALUES (:id_permiso,:id_aprueba,:descripcion_solicita, :ruta_aprueba)";
