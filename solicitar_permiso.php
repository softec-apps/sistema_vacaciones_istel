...
if ($_POST) {
    ...
    if ($existeRegistro) {
        ...
        create_flash_message(
            'Ya existe un permiso con las mismas horas de inicio y de fin para este dia del usuario.',
            'error'
        );
        redirect(RUTA_ABSOLUTA . "admin/solicitud_general");
        exit();
...
//este codigo multiplics los dias solicitdos por 4 o 8 pero deberia multiplicarse por 24 para luego dividirse por 24
