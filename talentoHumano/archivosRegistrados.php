...
$vista = vista2($pdo,$id_user);

?>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Archivos que registraste</h1>
                ...
                <table class="table table-bordered crud-table" id="tablaArchivosSubidos">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <form action="<?= RUTA_ABSOLUTA  ?>talentoHumano/archivosUsuarios" method="post">
