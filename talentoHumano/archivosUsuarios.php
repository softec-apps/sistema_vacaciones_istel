...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $vista = archivos_talentoHumano($pdo,$id_usuario,$id_user);
    if (!empty($vista)) {
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">En esta sección se ven los archivos de los usuarios que han solicitado un permiso</h6>
    </div>
    <div class="card-body">
