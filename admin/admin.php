                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary m-1" title="Editar datos del usuario"
                                                    ...
                                                    data-rol="<?= $rol_usuarios ?>" data-fecha_ingreso="<?= $fecha_ingreso ?>" onclick="cargarDatos(this)">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="<?php echo RUTA_ABSOLUTA ?>registrar_users">
                    ...
                    <div class="form-floating mb-3">
                        <div>
                            <label>Seleccione el rol del usuario</label>
                            <select class="form-control select2" id="roles" name="roles1"required onchange="mostrarOpciones()">
                                <option value="admin">Administrador</option>
                                <option value="jefe">Jefe o supervisor</option>
                                <option value="Talento_Humano">Talentos Humanos</option>
                                <option value="Funcionario">Funcionario</option>
