...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $vista = archivosDelFuncionarioAdmin($pdo,$id_usuario);
    if (!empty($vista)) {
...
?>
 <!-- Page Heading -->
 <h1 class="h3 mb-2 text-gray-800 mt-4 ml-2">Archivos registrados del usuario <?= $nombrePrueba ?></h1>

<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">En esta sección se ven los archivos registrados por talento humano</h6>
    </div>
    <div class="card-body">
