                ...
                <tbody>
                    <?php
                        foreach ($resultados as $key => $valor){
                            ...
                            if ($rol_usuarios == 'funcionario'||$rol_usuarios == 'Funcionario') {
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary m-1" title="Editar datos del usuario"
                                ...
                                data-fecha_ingreso="<?= $fecha_ingreso ?>" onclick="cargarDatos(this)">
                            ...
                            <form action="<?php echo RUTA_ABSOLUTA ?>calcular" method="post">
                                <input type="hidden" name="id_usuario" value="<?php echo $id_usuarios; ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="eliminarForm" action="<?php echo RUTA_ABSOLUTA ?>eliminar_users" method="post">
...
aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo RUTA_ABSOLUTA ?>actualizar_users" method="post">
...
<div class="modal fade" id="registrar_administradores" tabindex="-1" role="dialog" aria-labelledby="modalAdminLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo RUTA_ABSOLUTA ?>registrar_users" method="post">
                    <input type="hidden" name="cliente_id" value="">
